...
namespace NerdStore.Catalogo.Application.Services
{
    public class ProdutoAppService : IProdutoAppService
    {
        ...
        public async Task AdicionarProduto(ProdutoViewModel produtoViewModal)
        {
            var produto = _mapper.Map<Produto>(produtoViewModal);
            _produtoRepository.AdicionarProdutos(produto);

            await _produtoRepository.UnitOfWork.Commit();
        }

        public async Task AtualizarProduto(ProdutoViewModel produtoViewModal)
        {
            var produto = _mapper.Map<Produto>(produtoViewModal);
